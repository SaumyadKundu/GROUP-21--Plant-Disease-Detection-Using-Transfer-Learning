...
if uploaded_file is not None:
    ...
    prompt = f"Write a detailed description and prevention method for the disease {predicted_class_name} in plants. And also give me a link for medicines for {predicted_class_name} to buy in india"
